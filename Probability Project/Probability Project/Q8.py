...
h0_initial = float(input('how much you claim the population percentage (Have you ever planted a plant/tree?) ) '))
...
local = float(input('how many people have done any type of plantation? '))
