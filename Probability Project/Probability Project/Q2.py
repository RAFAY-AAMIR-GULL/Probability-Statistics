...
h0_initial = float(input('how much you claim the population percentage live/work near a factory? '))
...
local = float(input('how many people live/work near a factory? '))
