...
h0_initial = float(input('how much you claim the population percentage (status of petrol consumption?) ) '))
...
local = float(input('how many people think it is the same as it was in the last year (2020)? '))
